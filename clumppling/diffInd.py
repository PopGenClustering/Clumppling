...
from clumppling.funcs import load_Q_and_indinfo, load_Q_and_indinfo, align_popwise_membership
...
def main(args):
    ...
    logging.info("Consensus: {}".format(parameters['consensus']))

    # load files
    tic = time.time()
    logging.info("---------- Loading files ...")
    input_names, N_all, R_all, Q_all, K_all, ind2pop_all, popNind_all = load_Q_and_indinfo(input_base_path,parameters['consensus'])
